...
// Phù hợp index.html mới: rootEl đã là .card, dùng grid-2, btn, v.v.
// Lưu vào state.design và state.interventions; set localStorage 'num-arms'.
  ...
  rootEl.innerHTML = `
    ...
    <style>
      ...
      #dsg .pill { 
        ...
        font:600 12.5px/1.1 Inter, ui-sans-serif; border: none;
      }
      #dsg .form-input {
        width: 100%;
