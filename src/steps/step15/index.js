...
export const id = 15;
export const title = "Sơ đồ tiến hành nghiên cứu";
export const subtitle =
  "Sơ đồ hoá các bước chính (tuyển chọn, khám ban đầu, phân nhóm, can thiệp, theo dõi – đánh giá, xử lý số liệu).";
export const css = "./public/css/steps/step15.css";
